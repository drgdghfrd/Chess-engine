...
UCI::UCI(){
    ...
    if (!network().loadEmbedded()) {
        const char* candidates[] = {
            "nets/ChessZero-v1.0.9-current.nnue",
            "../nets/ChessZero-v1.0.9-current.nnue",
            "ChessZero-v1.0.9-current.nnue",
            "nets/ChessZero-v1.0.9-multi_1m.nnue",
            "../nets/ChessZero-v1.0.9-multi_1m.nnue",
            "ChessZero-v1.0.9-multi_1m.nnue",
            "nets/ChessZero-v1.0.9-single_1m.nnue",
            "../nets/ChessZero-v1.0.9-single_1m.nnue",
            "ChessZero-v1.0.9-single_1m.nnue",
            "nets/ChessZero-v1.0.9-sf250k.nnue",
            "../nets/ChessZero-v1.0.9-sf250k.nnue",
            "ChessZero-v1.0.9-sf250k.nnue",
            "nets/ChessZero-v1.0.9-ml.nnue",
            "../nets/ChessZero-v1.0.9-ml.nnue",
            "ChessZero-v1.0.9-ml.nnue",
            "nets/ChessZero-v1.0.9-sfdistill.nnue",
            "../nets/ChessZero-v1.0.9-sfdistill.nnue",
            "ChessZero-v1.0.9-sfdistill.nnue",
...
void UCI::setoption(const std::string&line){
    ...
    if(name=="Threads"){
        ...
        std::string f;
        if(ss>>f){
            const bool wantsEmbedded = (f=="built-in" || f=="builtin" || f=="embedded" || f=="embedded://ChessZero-v1.0.9-current.nnue");
            const bool ok = wantsEmbedded ? network().loadEmbedded() : network().load(f.c_str());
            if(!ok && !network().loaded())
                std::cout<<"info string nnue=load_failed arch="<<network().architectureName()<<" file="<<f<<" fallback=classic\n";
            else if(!ok)
                std::cout<<"info string nnue=loaded arch="<<network().architectureName()<<" source="<<network().file()<<" requested="<<f<<"\n";
            else
                std::cout<<"info string nnue=loaded arch="<<network().architectureName()<<" file="<<network().file()<<"\n";
        }
    ...
    while(std::getline(std::cin,l)){
        if(l=="uci"){
            ...
            std::cout<<"id name ChessZero v" << kVersion << "\n"
                     ...
                     <<"option name EvalFile type string default embedded://ChessZero-v1.0.9-current.nnue\n"
