...
checks.append(check('versionCode = 108' in s_app and 'versionName = "1.0.8"' in s_app, 'Android versionCode/versionName 1.0.8'))
checks.append(check('kVersion = "1.0.8"' in s_version, 'engine version 1.0.8'))
