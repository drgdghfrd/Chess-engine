...
checks.append(check('versionCode = 110' in s_app and 'versionName = "1.1.0"' in s_app, 'Android versionCode/versionName 1.1.0'))
checks.append(check('kVersion = "1.1.0"' in s_version, 'engine version 1.1.0'))
